...
function calculateSum() {
    ...
    const webtsiteCartValue = convertCartOptionToPrice(websiteCart.value);
    const webtsiteReceptionValue = convertReceptionOptionToPrice(websiteReception.value);
    const totalSum = websiteTypeValue + technologiesValue + webtsiteCartValue + webtsiteReceptionValue;
    renderSum(totalSum);
}
